 ...
 * specified Class, String arrays to arrays of the specified Class. The actual
 * {@link Converter} instance to be used can be registered for each possible
 * destination Class. Unless you override them, standard {@link Converter}
 ...
 * 
 * <p>
 * For backwards compatibility, the standard Converters for primitive types (and
 * the corresponding wrapper classes) return a defined default value when a
 * conversion error occurs. If you prefer to have a {@link ConversionException}
 * thrown instead, replace the standard Converter instances with instances
 * created with the zero-arguments constructor. For example, to cause the
 * Converters for integers to throw an exception on conversion errors, you could
 * do this:
 * </p>
 * 
 * <pre>
 ...
 * @version $Revision: 1.12.2.1 $ $Date: 2004-08-01 13:15:19 -0700 (Sun, 01 Aug
 *          2004) $
 * @since 1.7
 */
...
public class ConvertUtilsBean {
	 ...
	 * registered {@link Converter} for the <code>java.lang.String</code>
	 * class will be used, which allows applications to customize Object->String
	 ...
	 * 
	 * @param values
	 *            Values to be converted (may be null)
	 * @param clazz
